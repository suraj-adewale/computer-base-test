...
class DashBoard(QMainWindow):
	...
	def OpenTest(self,date):
   		...
   		self.question=Main(self.authorid,self.regno,self.othername,self.testtype,self.year,self.tittle,self.coursecode,self.timeallowed,self.constant,self.questions,self.answers)
   		self.question.show()
   		self.close()
